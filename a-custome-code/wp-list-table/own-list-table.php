...
// function list_table_edit_post()
// {
//     wp_enqueue_script( 'wlt-backend-js', get_template_directory_uri().'/a-custome-code/wp-list-table/js/list_edit.js', array('jquery-core'), '1.0', true );
//     wp_localize_script( 'wlt-backend-js', 'wlt',array('ajax_url'  => admin_url( 'admin-ajax.php' )));
// }
// add_action( 'admin_enqueue_scripts', 'list_table_edit_post' );
